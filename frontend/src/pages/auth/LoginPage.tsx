	...
	return (
		<div className='max-w-screen-xl mx-auto flex h-screen'>
			...
			<div className='flex-1 flex flex-col justify-center items-center'>
				<form className='flex sm:w-[300px] gap-4 flex-col' onSubmit={handleSubmit}>
				...
				<div className='flex flex-col gap-2 mt-4'>
					...
					<Link to='/signup'>
						<button className='btn rounded-full btn-primary text-white btn-outline w-full sm:w-[300px]'>Sign up</button>
					</Link>
				</div>
			</div>
		</div>
