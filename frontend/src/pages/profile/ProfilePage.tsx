...
const ProfilePage = () => {
	...
	return (
		...
		<div className="flex flex-col">
			...
			<img
				src={coverImg || profileUser.coverImage || "/cover.png"}
			...
			<div className="avatar absolute -bottom-16 left-4">
				...
				<img
					src={profileImg || profileUser.profileImage || "/avatar-placeholder.png"}
					alt="profile avatar"
				/>
				{isMyProfile && (
			...
			{!isMyProfile && (
				...
				>
				{state.data?._id && profileUser.followers.includes(state.data._id) ? "Unfollow" : "Follow"}
				</button>
			)}
			{(coverImg || profileImg) && (
			...
			<div className="flex gap-2">
				<div className="flex gap-1 items-center">
				<span className="font-bold text-xs">{profileUser.following.length}</span>
				<span className="text-slate-500 text-xs">Following</span>
				</div>
				<div className="flex gap-1 items-center">
				<span className="font-bold text-xs">{profileUser.followers.length}</span>
